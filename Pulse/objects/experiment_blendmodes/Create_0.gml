...
emitter = new pulse_local_emitter("sys2","particle2")
emitter.set_distribution_u(PULSE_RANDOM.EVEN,10).set_distribution_v(PULSE_RANDOM.EVEN,2).form_line(0,300).set_radius(0,40)
mode = 0
