...
emit = new pulse_local_emitter(system,"fire")
emit.force_to_edge=PULSE_TO_EDGE.FOCAL_LIFE
emit.set_focal_point(0,-500).set_direction_range(178,188).set_mask(0,.5)
...
emit_smaller = new pulse_local_emitter(system2,"fire_2")
...
emit_spark = new pulse_local_emitter(system2,"sparks")
...
//global.pulse.particle_factor=.1
